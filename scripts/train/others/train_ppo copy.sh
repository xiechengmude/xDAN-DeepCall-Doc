...
export EXPERIMENT_NAME=${train_data}-${test_data}-search-r1-ppo-qwen2.5-3b-rag
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    data.train_files=$TRAIN_DATA_DIR/train_e5_base.parquet \
    data.val_files=$TEST_DATA_DIR/test_e5_base.parquet \
