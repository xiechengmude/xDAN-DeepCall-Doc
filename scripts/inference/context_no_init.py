...
import pandas as pd
import json
from verl.utils.reward_score.rag_2 import generate_answer, check_answer_correct, em_check, generate_answer_zero_shot, extract_titles_and_texts
...
def filter_info(text):
    ...
    docs = extract_titles_and_texts(text)
