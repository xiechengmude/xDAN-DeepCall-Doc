...
if __name__ == '__main__':
    ...
    parser.add_argument('--result_file', default="results/ircot.json", help='Path to save answers JSON file')
    parser.add_argument('--context_file', default="/shared/eng/pj20/ircot/results.json", help='Directory containing context files')
