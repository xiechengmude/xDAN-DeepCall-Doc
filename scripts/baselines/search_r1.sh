...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo_r1 \
    ...
    data.val_files=data/mirage/test_mirage_r1.parquet \
    ...
    actor_rollout_ref.model.path=PeterJinGo/SearchR1-nq_hotpotqa_train-qwen2.5-3b-em-ppo-v0.2 \
    ...
    critic.model.path=PeterJinGo/SearchR1-nq_hotpotqa_train-qwen2.5-3b-em-ppo-v0.2 \
    ...
    retriever.topk=3 \
    2>&1 | tee search_r1_3b_mirage.log
