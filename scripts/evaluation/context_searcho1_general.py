...
if __name__ == '__main__':
    ...
    parser.add_argument('--result_file', default="results/searcho1_haiku_wiki_general.json", help='Path to save answers JSON file')
    ...
    parser.add_argument('--context_file', default="data/search_o1/results_wiki_general.json", help='Directory containing context files')
    ...
    process_dataset(args.input_file, args.result_file, args.context_file, args.num_workers, args.random_seed, True, False) 