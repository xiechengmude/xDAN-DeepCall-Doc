...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=verl_checkpoints/s3_3_3_3/actor/global_step_100 \
    ...
    critic.model.path=verl_checkpoints/s3_3_3_3/critic/global_step_100 \
    ...
    retriever.topk=3 \
    2>&1 | tee evaluation_s3_3_3_3.log
