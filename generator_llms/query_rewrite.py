...
def rewrite_query(query: str, rewriter_model: str, api_url: str = "http://localhost:8000/v1/chat/completions") -> str:
...
def main():
    ...
    parser.add_argument("--rewriter", type=str, required=True, help="The rewriter model to use")
    args = parser.parse_args()
    
    try:
        rewritten_query = rewrite_query(args.query, args.rewriter, args.api_url)
