...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=verl_checkpoints/search-agent-ppo-qwen2.5-7b-rag-e5-ug-v2/actor/global_step_550 \
    ...
    critic.model.path=verl_checkpoints/search-agent-ppo-qwen2.5-7b-rag-e5-ug-v2/critic/global_step_550 \
